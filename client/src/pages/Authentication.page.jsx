            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    {isRegister && (
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <div className="mt-1">
                                    <input
                                        id="firstName" name="firstName" type="text" ref={firstNameField} required
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input
                                        id="lastName" name="lastName" type="text" ref={lastNameField} required
                                        className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input
                                        id="email" name="email" type="email" ref={emailField} required
                                        className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input
                                        id="phone" name="phone" type="tel" pattern="[7-9]{1}[0-9]{9}" ref={phoneField} required
                                        className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    <input
                                        id="password" name="password" type={showPassword ? "text" : "password"} ref={passwordField} required
                                        className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        ...
                        <>
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <input
                                            id="emailOrPhone" name="emailOrPhone" type="text" ref={emailOrPhoneField} required
                                            className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    ...
                    <p className="text-center mt-2">
                        {isRegister ?
                            <>Already have an account? <span className="text-blue-600" onClick={handleIsRegister}> Login</span></>
                            : <>Don't have an account? <span className="text-blue-600" onClick={handleIsRegister}> Register</span></>
                        }
                    </p>
